...
stage('Update ES Health') {
  ...
  node('docker') {
    ...
    def indexResp = httpRequest acceptType: 'APPLICATION_JSON', contentType: 'APPLICATION_JSON', httpMode: 'PUT', requestBody: respObj, authentication: "es-auth", url: "$url", validResponseCodes: '100:500'
